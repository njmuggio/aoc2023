...
symbol_found:
  currentGearRatioSum = 1;
  int adjacentNumCount = 0;
...
#define CHECK_CELL(dirName, nextDirName, col, row)                                                               \
  ...
  int aAmtToAdd[8] = {[2] = currentGearRatioSum};
  totalGearRatios += aAmtToAdd[adjacentNumCount];
